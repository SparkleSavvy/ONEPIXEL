...
- Mrpack: [Right click to copy link](https://github.com/SparkleSavvy/ONEPIXEL/releases/download/0.0.2a/ONEPIXEL.0.0.3a.mrpack)
- Zip: [Right click to copy link](https://github.com/SparkleSavvy/ONEPIXEL/releases/download/0.0.2a/ONEPIXEL.0.0.3a.zip)
