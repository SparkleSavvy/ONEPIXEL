...
The project now has a version manager! [Try it out](https://github.com/SparkleSavvy/ONEPIXEL-Manager)

## Ways to install:
#### Mrpack
- Prism, PolyMC, Modrinth, XMCL and another.
#### Zip [Not in active develop]
...
- Mrpack: [Right click to copy link](https://github.com/SparkleSavvy/ONEPIXEL/releases/download/0.0.5a/ONEPIXEL.0.0.5a.mrpack)
